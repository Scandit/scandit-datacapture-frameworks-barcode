...
public class RegisterCustomViewProviderListenerCommand: BarcodePickModuleCommand {
    private let module: BarcodePickModule
    private let viewId: Int
    public init(module: BarcodePickModule, _ method: FrameworksMethodCall) {
        self.module = module
    ...
    public func execute(result: FrameworksResult) {
        ...
        result.registerViewSpecificCallback(
            viewId,
            eventNames: [
                "BarcodePickViewHighlightStyleCustomViewProvider.viewForRequest"
            ]
        )
        module.registerCustomViewProviderListener(
            viewId: viewId,
            result: result
        )
    }
...
public class UnregisterCustomViewProviderListenerCommand: BarcodePickModuleCommand {
    private let module: BarcodePickModule
    private let viewId: Int
    public init(module: BarcodePickModule, _ method: FrameworksMethodCall) {
        self.module = module
    ...
    public func execute(result: FrameworksResult) {
        ...
        module.unregisterCustomViewProviderListener(
            viewId: viewId,
            result: result
        )
    }
