...
public class BarcodePickModuleCommandFactory {
    ...
    public static func create(module: BarcodePickModule, _ method: FrameworksMethodCall) -> BarcodePickModuleCommand? {
        ...
        case "registerCustomViewProviderListener":
            return RegisterCustomViewProviderListenerCommand(module: module, method)
        case "unregisterCustomViewProviderListener":
            return UnregisterCustomViewProviderListenerCommand(module: module, method)
