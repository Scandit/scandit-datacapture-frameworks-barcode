    ...
    public func execute(result: FrameworksResult) {
        ...
        result.registerViewSpecificCallback(
            ...
            eventNames: [
                ...
                "BarcodeCountViewListener.didTapCluster",
            ]
        )
    ...
    public func execute(result: FrameworksResult) {
        ...
        result.registerViewSpecificCallback(
            ...
            eventNames: [
                ...
                "BarcodeCountListener.didUpdateSession",
            ]
        )
...
public class FinishBarcodeCountOnSessionUpdatedCommand: BarcodeCountModuleCommand {
    private let module: BarcodeCountModule
    private let viewId: Int
    public init(module: BarcodeCountModule, _ method: FrameworksMethodCall) {
        self.module = module
    ...
    public func execute(result: FrameworksResult) {
        module.finishBarcodeCountOnSessionUpdated(
            viewId: viewId,
            result: result
        )
    }
...
public class SetBarcodeCountCaptureListCommand: BarcodeCountModuleCommand {
    ...
    private let hasTransformer: Bool
    public init(module: BarcodeCountModule, _ method: FrameworksMethodCall) {
        self.module = module
        self.viewId = method.argument(key: "viewId") ?? Int()
        self.captureListJson = method.argument(key: "captureListJson") ?? ""
        self.hasTransformer = method.argument(key: "hasTransformer") ?? Bool()
    }
    ...
    public func execute(result: FrameworksResult) {
        ...
        result.registerViewSpecificCallback(
            ...
            eventNames: [
                ...
                "BarcodeCountCaptureListListener.didCompleteCaptureList",
                "BarcodeDataTransformer.transformBarcodeData",
            ]
        )
...
public class SubmitBarcodeDataTransformerResultCommand: BarcodeCountModuleCommand {
    private let module: BarcodeCountModule
    private let viewId: Int
    private let transformedData: String?
    public init(module: BarcodeCountModule, _ method: FrameworksMethodCall) {
        self.module = module
        self.viewId = method.argument(key: "viewId") ?? Int()
        self.transformedData = method.argument(key: "transformedData")
    }

    public func execute(result: FrameworksResult) {
        module.submitBarcodeDataTransformerResult(
            viewId: viewId,
