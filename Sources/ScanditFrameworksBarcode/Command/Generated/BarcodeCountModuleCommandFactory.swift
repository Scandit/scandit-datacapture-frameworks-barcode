...
public class BarcodeCountModuleCommandFactory {
    ...
    public static func create(module: BarcodeCountModule, _ method: FrameworksMethodCall) -> BarcodeCountModuleCommand?
    {
        ...
        case "finishBarcodeCountOnSessionUpdated":
            return FinishBarcodeCountOnSessionUpdatedCommand(module: module, method)
        ...
        case "submitBarcodeDataTransformerResult":
            return SubmitBarcodeDataTransformerResultCommand(module: module, method)
