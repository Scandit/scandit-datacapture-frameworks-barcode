    ...
    public func dataCaptureView(addOverlay overlayJson: String, to view: DataCaptureView) throws {
        ...
        dispatchMain { [weak self] in
            ...
            do {
                ...
                try self.barcodeTrackingDeserializer.basicOverlay(fromJSONString: overlayJson, withMode: mode) :
                try self.barcodeTrackingDeserializer.advancedOverlay(fromJSONString: overlayJson, withMode: mode)
